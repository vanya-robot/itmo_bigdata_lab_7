-- Create source_data table with columns matching lab5 preprocessing
...
-- Insert sample rows (some variety, including a negative to test imputation)
...
-- Create predictions table used by lab_6 pipeline
